...
if orders is None:
    st.error("⚠️ Tidak dapat memuat data. Pastikan file CSV ada di folder yang sama dengan script.")
    st.info("📁 File yang diperlukan: superstore_order.csv, superstore_product.csv, superstore_customer.csv, product_stock.csv")
    st.stop()
...
# Footer
st.markdown("---")
st.markdown("Dashboard created with Streamlit & Plotly | Data: Superstore CSV Files")